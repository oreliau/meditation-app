const soundscapeSources: Record<string, number> = {
  "amber-dawn": require("../../../assets/sounds/leberch-meditation-513747.mp3"),
  "silent-river": require("../../../assets/sounds/monume-meditation-music-577979.mp3"),
  "misty-forest": require("../../../assets/sounds/solarflex-meditation-meditation-music-589064.mp3"),
};
